...
public class SetupPanel : MonoBehaviour
{
    ...
    [SerializeField] private Toggle m_enablePrintersToggle;
    ...
    public void StartExperience()
    {
        ...
        GameManager.Instance.InitializeGame(gameDuration * 60, language, m_skipIntroToggle.isOn, m_skipAnimsToggle.isOn, m_enablePrintersToggle.isOn);
    }
}
